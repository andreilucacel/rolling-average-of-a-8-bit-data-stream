...
HD_PWD='C:/vivado/DataGenerator/DataGenerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log average.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source average.tcl
