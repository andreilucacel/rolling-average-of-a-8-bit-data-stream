...
HD_PWD='C:/vivado/RollingAvg/DataGenerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log average.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source average.tcl -notrace
